...
.comment_input > input:first-child {
  max-width: 60px;
  margin-right: 10px;
}

.comment_input > input:last-child {
  width: calc(100% - 70px);
}
</style>
